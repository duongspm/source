<!-- <div class="phone_mobi goidienthoai">
    <ul>
        <li class="goidien">
            <a title="title" id="goidien" class="blink_me">
        ...
        <li class="content">
            <a href="tel:<?= preg_replace('/[^0-9]/', '', $optsetting['hotline']); ?>"
                class="blink_me"><?= $optsetting['hotline'] ?></a>
            <a href="tel:<?= preg_replace('/[^0-9]/', '', $optsetting['dienthoai']); ?>"
                class="blink_me"><?= $optsetting['dienthoai'] ?></a>
        </li>


        <li>
            <a id="chatzalo" href="https://zalo.me/<?= preg_replace('/[^0-9]/', '', $optsetting['zalo']); ?>"
                title="title" class="blink_me">
        ...
        <li>
            <a id="chatfb" href="<?= $optsetting['fanpage'] ?>" title="title" class="blink_me">
        ...
        <li>
            <a id="chatfb" href="<?= $optsetting['chiduong'] ?>" title="title" class="blink_me">
...
<div class="fixbar">
    <ul class="w-clear">
        <li>
            <a href="">
                <span class="icon-home-new"><i class="fa fa-home" aria-hidden="true"></i></span><span
                    class="text-link-toolbar">Trang chủ</span>
            </a>
        </li>
        <li>
            <a href="tel:<?=$func->parsePhone($optsetting['hotline'])?> ">
                <span class="icon-cart-new"><i class="fa fa-phone-square" aria-hidden="true"></i></span><span
                    class="text-link-toolbar"><?=$func->parsePhone($optsetting['hotline'])?></span>
            </a>
        </li>
        <li>
            <a href="lien-he">
                <span class="icon-hotdeal-new"><i class="fa fa-map-marker" aria-hidden="true"></i></span><span
                    class="text-link-toolbar">Liên hệ</span>
            </a>
        </li>
        <li>
            <a href="gio-hang">
...
<div class="support-online">
    <div class="support-content" style="display: block;">
        <a target="_blank" href="tel:<?=$func->parsePhone($optsetting['hotline'])?>" class="not-loading call-now"
            rel="nofollow">
